			...
			<div class="container">      
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
							...
							<li><a href="listar-vagas.php">Vagas</a></li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu animated fadeOutUp" style="display: none; opacity: 1;">
									<li><a href="company-detail.html">Empresa detalhe</a></li>
									<li><a href="cadastrar-empresa.php">Cadastrar vaga</a></li>
									<li><a href="job-include.php">Cadastrar Vaga</a></li>
									<li><a href="cadastrar-usuario-emp.php">Cadastrar Usuário</a></li>
								</ul>
							</li>

		...
		<section class="login-wrapper">
			<div class="container">
				<div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
					<form method="POST" action="core/valida.php">
						<img class="img-responsive" alt="logo" src="img/logo.png">
						<input type="text" class="form-control input-lg" name="login" placeholder="Usuário">
						...
						<p>Não tenho conta. <a href="create-account.php">Criar uma conta</a></p>
					</form>
				</div>
